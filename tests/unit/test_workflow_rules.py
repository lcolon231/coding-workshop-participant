...
class TestActorDerivation:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (Role.ENGINEER, "stranger", frozenset()),
            (Role.ENGINEER, "reporter", frozenset({Actor.REPORTER})),
            (Role.ENGINEER, "assignee", frozenset({Actor.ASSIGNED_ENGINEER})),
            (Role.ENGINEER, "reporter_and_assignee",
             frozenset({Actor.ASSIGNED_ENGINEER, Actor.REPORTER})),
